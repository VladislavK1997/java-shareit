...
class ItemRequestRepositoryTest {
    ...
    void findByRequesterIdOrderByCreatedDesc_ShouldReturnUserRequests() {
        ...
        createRequest("Need drill", requester, LocalDateTime.now().minusDays(1));
        createRequest("Need hammer", requester, LocalDateTime.now());
    ...
    void findByRequesterIdNotOrderByCreatedDesc_ShouldReturnOtherUsersRequests() {
        ...
        createRequest("Request 1", user1, LocalDateTime.now().minusDays(1));
        createRequest("Request 2", user2, LocalDateTime.now());
