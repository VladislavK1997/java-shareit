...
public class BookingServiceImpl implements BookingService {
    ...
    @Override
    public List<BookingResponseDto> getBookingsByBooker(BookingState state, Long bookerId, int from, int size) {
    ...
    @Override
    public List<BookingResponseDto> getBookingsByOwner(BookingState state, Long ownerId, int from, int size) {
        getUserById(ownerId);
        Pageable pageable = PageRequest.of(from / size, size, Sort.by(Sort.Direction.DESC, "start"));
