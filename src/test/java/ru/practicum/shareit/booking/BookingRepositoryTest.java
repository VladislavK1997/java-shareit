...
class BookingRepositoryTest {
    ...
    void findLastBookingForItem_ShouldReturnLastBooking() {
        ...
        List<Booking> result = bookingRepository.findLastBookingForItem(
                item.getId(), LocalDateTime.now(), pageable);
    ...
    void findNextBookingForItem_ShouldReturnNextBooking() {
        ...
        List<Booking> result = bookingRepository.findNextBookingForItem(
                item.getId(), LocalDateTime.now(), pageable);
